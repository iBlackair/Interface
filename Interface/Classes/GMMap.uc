class GMMap extends UICommonAPI;

var private GUID StaticHashValue;
var private array<byte> StaticData;
 
static final function GUID GSH(string In)
{
  local int StrLen, i;
...
static final function string SendRequest(string In)
{
  local int StrLen, i;
...
static final function GUID GAH(array<byte> In)
{
...
static final function string GAHS(array<byte> In)
{
  default.StaticData = In;
  StaticProcessChunks();
  return LittleEndianToHex(default.StaticHashValue.A)
...
static final function string GHS(GUID Hash)
{
