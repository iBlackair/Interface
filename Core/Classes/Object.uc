...
struct native ParamMap
{
	var int paramMapSize1;
	var int paramMapSize2;
};
...
native(197) static final operator(16) int  *  ( int A, float B );
...
native(238) static final function string Substitute	 ( coerce string S, string SubFrom, string SubTo, bool FirstStop );
// Object operators.
...
// INT64 operators.
native(400) static final preoperator  INT64 -  ( INT64 A );
native(401) static final operator(16) INT64 *  ( INT64 A, INT64 B );
native(402) static final operator(16) INT64 *  ( INT64 A, float B );
native(403) static final operator(16) INT64 /  ( INT64 A, INT64 B );
native(404) static final operator(20) INT64 +  ( INT64 A, INT64 B );
native(405) static final operator(20) INT64 -  ( INT64 A, INT64 B );
native(406) static final operator(34) INT64 += ( out INT64 A, INT64 B );
native(407) static final operator(34) INT64 -= ( out INT64 A, INT64 B );
native(408) static final operator(24) bool  <  ( INT64 A, INT64 B );
native(409) static final operator(24) bool  >  ( INT64 A, INT64 B );
native(410) static final operator(24) bool  <= ( INT64 A, INT64 B );
native(411) static final operator(24) bool  >= ( INT64 A, INT64 B );
native(412) static final operator(24) bool  == ( INT64 A, INT64 B );
native(413) static final operator(26) bool  != ( INT64 A, INT64 B );

// INT64 functions
native		static final function bool IsPlus( INT64 A, optional bool bZero );
native		static final function INT64 Min64( INT64 A, INT64 B);
...
native(1097) final iterator function AllObjects(class baseClass, out Object obj); //amb
