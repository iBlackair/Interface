...
var	transient bool		 bHasShadow;			// Is Draw Shadow (Following Game Option)   

var bool bColorChangeWhenFocus;	//마우스에의해 포커스를 받을때 강조효과를 줄지여부
var transient bool bUseDramaticSunLight; //마우스에의해 포커스를 받아 강조효과를 줄때 true로 셋팅한다
var bool bIsMyTargetPawn; //타겟팅이 된 폰인지 저장한다.
...
var(Display)		bool	ForceAvoidProjectorsInGameMode;	// Forcing Projectors cannot project onto this actor In GameMode(Not Editor, Illuminate)

var(ZoneLight)		bool	bSunAffect;
...
var bool				L2NeedTick;
var(Display)	 bool			bCheckChangableLevel;
...
var(SpawnSound) byte         SoundPitch;
...
var(Collision) int        CurrentAlpha;			// Current alpha value of Actor ( not use Zero value ), ttmayrin
...
//var(Movement) rotator     SwayRotationOrig;
...
struct NMagicInfo
{	
	// SkillEffect - by animaO
	var L2SkillEffect	EffectInfo;
	var int		DummyPtr;	// 
...
// #endif
	...
	var bool	m_bWorking;					// lancelot 2010. 7. 14.
...
native final function SetActorViewType( EActorViewType a_ActorViewType );
native final function SetAlphaTexModifier( int a_Alpha );
