...
AUTOGENERATE_NAME(ChangePawnState)
...
enum EL2EventCmd
{
    ...
    LEC_Show                =1,
    LEC_Play                =2,
    LEC_CastleGoodEffectShow=3,
    LEC_CastleEvilEffectShow=4,
    LEC_NPCSpawnToShow      =5,
    LEC_NPCSpawnToHide      =6,
    LEC_MAX                 =7,
};
enum EFilterState
{
...
public:
    ...
    BITFIELD CanIgnoreCollision:1;
    BITFIELD bDeleteNow:1;
    BITFIELD bAlwaysVisible:1;
    BITFIELD bDynamicActorFilterState:1;
    ...
    BITFIELD bHasShadow:1;
    BITFIELD bColorChangeWhenFocus:1;
    BITFIELD bUseDramaticSunLight:1;
    BITFIELD bIsMyTargetPawn:1;
    ...
    BITFIELD ForceAvoidProjectorsInGameMode:1;
    BITFIELD bSunAffect:1;
    ...
    INT VehicleID GCC_PACK(4);
    FVector RelativeLocInVehicle;
    FRotator L2DesriedRotator;
    ...
    INT CurrentAlpha GCC_PACK(4);
    BITFIELD bIgnoreOutOfWorld:1 GCC_PACK(4);
    BITFIELD bBounce:1;
    ...
    DECLARE_FUNCTION(execSetAlphaTexModifier);
    DECLARE_FUNCTION(execSetActorViewType);
...
struct ENGINE_API FNCollisionInfo
{
    FVector RelativeLocation;
    FLOAT CollisionRadius;
    FLOAT CollisionHeight;
...
struct ENGINE_API FNIllusionParam
{
    FLOAT RemainTime;
    FLOAT SpawnDelay;
    ...
    FName SeqName;
    FRotator Rotation;
    FColor IllusionColor;
    BITFIELD bUseIllusionColor:1 GCC_PACK(4);
};

struct ENGINE_API FNIllusionPawnParam
{
    class APawn* IllusionPawn;
    FLOAT RemainTime;
    FLOAT TotalTime;
};
...
struct APawn_eventChangePawnState_Parms
{
    INT iState;
};
...
struct APawn_eventGetEffTargetLocation_Parms
{
    FVector LocVector;
};
...
public:
    ...
    TArrayNoInit<FNCollisionInfo> ExCollisionInfos;
    TArrayNoInit<INT> NQuestList;
    TArrayNoInit<INT> NQuestStepList;
    FLOAT fAutoTargetPendingTime;
    class APawn* AutoTargetPawn;
    BITFIELD bNeedSetPawnResource:1 GCC_PACK(4);
    BITFIELD bNeedPostSetPawnResourceProcess:1;
    BITFIELD bPendingTransform:1;
    BITFIELD bColosseumSelected:1;
    FCompressedPosition PawnPosition GCC_PACK(4);
    INT ColosseumTeam;
    INT ColosseumPartyNum;
    TArrayNoInit<class USound*> SkillLoopingSoundList;
    TArrayNoInit<FNIllusionParam> NIllusionSpawnList;
    TArrayNoInit<FNIllusionPawnParam> NIllusionPawnList;
    FName ChargeAniName;
    BITFIELD bChangeWeapon:1 GCC_PACK(4);
    BITFIELD bUseDefaultMesh:1;
    BITFIELD bRelativeSoundRadius:1;
    INT EquipItem GCC_PACK(4);
    BITFIELD bDamageEffectRelativeCollisionRadius:1 GCC_PACK(4);
    BITFIELD HasDamageEffectOffsetForLargePawn:1;
    FLOAT DamageEffectOffset GCC_PACK(4);
    INT PawnState;
    BITFIELD bHideRightHandMesh:1 GCC_PACK(4);
    BITFIELD bHideLeftHandMesh:1;
    BITFIELD bBR_ShowTargetName:1;
    TArrayNoInit<FChannelingData> ChannelingEmitters GCC_PACK(4);
    FName ChannelingEmitterName;
    FName ChannelingBoneName;
    BITFIELD bAutoDestroyWhenCurrentAnimEnd:1 GCC_PACK(4);
    BITFIELD m_bSheathing:1;
    BITFIELD IsClientSidePawn:1;
    FName ClientSidePawnAnim GCC_PACK(4);
    FName SavedMeshName;
    INT m_DualCastBlendBoneIdx[4];
    FLOAT m_BlendFactor;
    FColor DynamicHairColor;
    BITFIELD bUseDynamicHairColor:1 GCC_PACK(4);
    INT m_nHairStyle GCC_PACK(4);
    INT m_nMeshType;
    BYTE extrudeMeshRenderType;
    BYTE extrudeMeshVisibleState;
    FLOAT extrudeMeshTime;
    FLOAT burningProgressTime;
    INT L2NPCSpawnEventID;
    INT CurAtkAnimIndex;
    INT FlyToLocationType;
    ...
    FHitFXData HitFx[8];
    INT HitFxTicker;
    TArrayNoInit<FName> ClientSidePawnAnimList;
    BITFIELD bPlayingRandomly:1 GCC_PACK(4);
    INT PlayingAnimIndex GCC_PACK(4);
    FName IntervalAnim;
    FName ForcedPlayAnimFirst;
    BITFIELD bIntervalAnimPlaying:1 GCC_PACK(4);
    FRotator RecoiledAngle GCC_PACK(4);
    INT RecoiledAngleType;
    BITFIELD bBeHitNoDamaged:1 GCC_PACK(4);
    DECLARE_FUNCTION(execGetSwimWaitAnimName);
    DECLARE_FUNCTION(execGetSwimAttackWaitAnimName);
    DECLARE_FUNCTION(execGetDeathWaitAnimName);
    DECLARE_FUNCTION(execGetSitWaitAnimName);
    DECLARE_FUNCTION(execGetAtkWaitAnimName);
    DECLARE_FUNCTION(execGetWaitAnimName);
    DECLARE_FUNCTION(execGetRunAnimName);
    DECLARE_FUNCTION(execGetWalkAnimName);
    DECLARE_FUNCTION(execIsMeshLoaded);
    ...
    DECLARE_FUNCTION(execSetWeaponHide);
    DECLARE_FUNCTION(execPlayAnimUM);
    DECLARE_FUNCTION(execForceCrouch);
    DECLARE_FUNCTION(execReachedDestination);
    DECLARE_FUNCTION(execRemoveHungerEffect);
    DECLARE_FUNCTION(execAddHungerEffect);
    DECLARE_FUNCTION(execGet4WayDirection);
    DECLARE_FUNCTION(execSetTwistLook);
    void eventChangePawnState(INT iState)
    {
        APawn_eventChangePawnState_Parms Parms;
        Parms.iState=iState;
        ProcessEvent(FindFunctionChecked(ENGINE_ChangePawnState),&Parms);
    }
    ...
    {
        APawn_eventGetEffTargetLocation_Parms Parms;
...
public:
    ...
    TArrayNoInit<class USound*> SpawnSound GCC_PACK(4);
    FLOAT SoundDelay;
    FLOAT SoundPitchMin;
    FLOAT SoundPitchMax;
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(AWeaponFire)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(ACarriedObject)
};
...
class ENGINE_API AL2CenterdDiamond : public AActor
{
public:
    FLOAT HeightRate;
    FLOAT RadiusRate;
    class UTexture* DiaTexture[4];
    FLOAT DiaSpeed[4];
    FLOAT DiaWeight[4];
    FMatrix LocalToWorldMatrix;
    DECLARE_CLASS(AL2CenterdDiamond,AActor,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(AL2CenterdDiamond)
};
...
class ENGINE_API URealtimeGenerationTexture : public UTexture
{
public:
    DECLARE_CLASS(URealtimeGenerationTexture,UTexture,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(URealtimeGenerationTexture)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UScriptedTexture)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UMaterialSequence)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UTexOscillatorTriggered)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UTexPannerTriggered)
};
...
class ENGINE_API UL2SkillEffect : public UObject
{
public:
    FStringNoInit Desc;
    INT SkillID;
    TArrayNoInit<class UL2EffectEmitter*> CastingAction;
    TArrayNoInit<class UL2EffectEmitter*> ChannelingAction;
    TArrayNoInit<class UL2EffectEmitter*> PreshotAction;
    TArrayNoInit<class UL2EffectEmitter*> ShotAction;
    TArrayNoInit<class UL2EffectEmitter*> ExplosionAction;
    TArrayNoInit<class UL2EffectEmitter*> UnionTargetAction;
    FLOAT FlyingTime;
    FLOAT TotalScaleSize;
    BITFIELD bHideRightHandMesh:1 GCC_PACK(4);
    BITFIELD bHideLeftHandMesh:1;
    BITFIELD bShowCameraEffectOnlyMe:1;
    class UClass* CastingCameraEffectInfoClass GCC_PACK(4);
    class UClass* ShotCameraEffectInfoClass;
    DECLARE_CLASS(UL2SkillEffect,UObject,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UL2SkillEffect)
};
...
struct ENGINE_API FMeshComponentData
{
    FName MeshName;
    TArrayNoInit<FName> TexNames;
    FName TexChangableName;
    INT BodyPart;
    BITFIELD bAnimOwner:1 GCC_PACK(4);
    INT SimulationType GCC_PACK(4);
    INT AttachType;
    FName AttachBoneName;
    FVector AttachOrigin;
    FRotator AttachRotOrigin;
    INT AttachMirrorType;
    FVector RenderScale;
    FColor ColorVariationColor;
    BITFIELD bRender:1 GCC_PACK(4);
};


class ENGINE_API UMeshComponent : public UObject
{
public:
    class AActor* Owner;
    class UMesh* Mesh;
    class UMeshInstance* MeshInstance;
    TArrayNoInit<class UMaterial*> Materials;
    class UMeshComponent* LastMeshComponent;
    class UMeshComponent* NextMeshComponent;
    class UMeshComponent* AnimMeshComponent;
    FMeshComponentData MeshData;
    FLOAT fAlphaFactor;
    BITFIELD bLoaded:1 GCC_PACK(4);
    BITFIELD bByResourceManager:1;
    BYTE MeshComponentStatus GCC_PACK(4);
    INT SkinnedDataIndex;
    BITFIELD m_bRender:1 GCC_PACK(4);
    DECLARE_CLASS(UMeshComponent,UObject,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UMeshComponent)
};


class ENGINE_API UMeshContainer : public UObject
{
public:
    class AActor* Owner;
    class UMeshComponent* FirstMeshComponent;
    FMeshComponentArrayPtr MeshComponentArray[41];
    FMeshComponentArrayPtr MeshComponentBufferArray[41];
    BITFIELD bLoaded:1 GCC_PACK(4);
    FSphere BoundingVolume GCC_PACK(4);
    FBox BoundingBox;
    DECLARE_CLASS(UMeshContainer,UObject,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UMeshContainer)
};
...
AUTOGENERATE_FUNCTION(AActor,-1,execSetAlphaTexModifier);
AUTOGENERATE_FUNCTION(AActor,-1,execSetActorViewType);
...
AUTOGENERATE_FUNCTION(APawn,-1,execGetSwimWaitAnimName);
AUTOGENERATE_FUNCTION(APawn,-1,execGetSwimAttackWaitAnimName);
AUTOGENERATE_FUNCTION(APawn,-1,execGetDeathWaitAnimName);
AUTOGENERATE_FUNCTION(APawn,-1,execGetSitWaitAnimName);
AUTOGENERATE_FUNCTION(APawn,-1,execGetAtkWaitAnimName);
AUTOGENERATE_FUNCTION(APawn,-1,execGetWaitAnimName);
AUTOGENERATE_FUNCTION(APawn,-1,execGetRunAnimName);
AUTOGENERATE_FUNCTION(APawn,-1,execGetWalkAnimName);
AUTOGENERATE_FUNCTION(APawn,-1,execIsMeshLoaded);
...
AUTOGENERATE_FUNCTION(APawn,-1,execSetWeaponHide);
...
AUTOGENERATE_FUNCTION(APawn,-1,execRemoveHungerEffect);
AUTOGENERATE_FUNCTION(APawn,-1,execAddHungerEffect);
...
DECLARE_NATIVE_TYPE(Engine,URealtimeGenerationTexture);
DECLARE_NATIVE_TYPE(Engine,UExtraMeshData);
DECLARE_NATIVE_TYPE(Engine,AL2Alarm);
DECLARE_NATIVE_TYPE(Engine,AL2CenterdDiamond);
...
DECLARE_NATIVE_TYPE(Engine,UL2SkillEffect);
DECLARE_NATIVE_TYPE(Engine,AMarkProjector);
DECLARE_NATIVE_TYPE(Engine,UMeshComponent);
DECLARE_NATIVE_TYPE(Engine,UMeshContainer);
...
#define AUTO_INITIALIZE_REGISTRANTS_ENGINE \
	...
	URealtimeGenerationTexture::StaticClass(); \
	UExtraMeshData::StaticClass(); \
	AL2Alarm::StaticClass(); \
	AL2CenterdDiamond::StaticClass(); \
...
{ 
	...
	MAP_NATIVE(AActor,execSetAlphaTexModifier)
	MAP_NATIVE(AActor,execSetActorViewType)
...
{ 
	MAP_NATIVE(APawn,execGetSwimWaitAnimName)
	MAP_NATIVE(APawn,execGetSwimAttackWaitAnimName)
	MAP_NATIVE(APawn,execGetDeathWaitAnimName)
	MAP_NATIVE(APawn,execGetSitWaitAnimName)
	MAP_NATIVE(APawn,execGetAtkWaitAnimName)
	MAP_NATIVE(APawn,execGetWaitAnimName)
	MAP_NATIVE(APawn,execGetRunAnimName)
	MAP_NATIVE(APawn,execGetWalkAnimName)
	MAP_NATIVE(APawn,execIsMeshLoaded)
	...
	MAP_NATIVE(APawn,execSetWeaponHide)
	MAP_NATIVE(APawn,execPlayAnimUM)
	MAP_NATIVE(APawn,execForceCrouch)
	MAP_NATIVE(APawn,execReachedDestination)
	MAP_NATIVE(APawn,execRemoveHungerEffect)
	MAP_NATIVE(APawn,execAddHungerEffect)
